...
public class UsuarioController {
	...
	@GetMapping
	public List<Usuario> listarUsuarios(){return servico.listarUsuarios();}
	
	@PostMapping
	public Usuario salvarUsuario(@RequestBody Usuario user){return servico.salvarUsuario(user);}
	...
	@DeleteMapping("{id}")
	public void deletarUsuario(@PathVariable Long id) {servico.deletarUsuarioPeloId(id);}
	
	@PutMapping("{id}")
	public Usuario alterarUsuario(@PathVariable Long id, @RequestBody Usuario user) {return (servico.alterarUsuario(user, id));}
